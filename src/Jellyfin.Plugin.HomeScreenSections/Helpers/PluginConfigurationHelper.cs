...
namespace Jellyfin.Plugin.HomeScreenSections.Helpers
{
    ...
    public static class PluginConfigurationHelper
    {
        ...
        /// <param name="required">Whether this field is required (enforces validation)</param>
        /// <returns>Configuration option for a checkbox</returns>
        public static PluginConfigurationOption CreateCheckbox(string key, string name, string description, bool defaultValue = false, bool userOverridable = true, bool isAdvanced = false, bool required = false)
        {
        ...
        public static PluginConfigurationOption CreateDropdown(string key, string name, string description, string[] options, string[]? labels = null, string? defaultValue = null, bool userOverridable = true, bool isAdvanced = false, bool required = false)
        {
            return new PluginConfigurationOption
            {
                Key = key,
        ...
        public static PluginConfigurationOption CreateTextBox(string key, string name, string description, string defaultValue = "", bool userOverridable = true, bool isAdvanced = false, bool required = false, string? placeholder = null, int? minLength = null, int? maxLength = null, string? pattern = null, string? validationMessage = null)
        {
            return new PluginConfigurationOption
            {
                Key = key,
        ...
        public static PluginConfigurationOption CreateNumberBox(string key, string name, string description, double defaultValue = 0, bool userOverridable = true, bool isAdvanced = false, bool required = false, string? placeholder = null, double? minValue = null, double? maxValue = null, double? step = null, string? validationMessage = null)
        {
            return new PluginConfigurationOption
            {
                Key = key,
